...
function setLanguage(language) {
    ...
    const texts = {
        'en': {
            ...
            'events-up-1-title' : "Omaggio, e grazie infinite, a Berio e Ravel", 
            'events-up-1-text' : "A concert to pay homage to Berio and Ravel, on the occasion of the 100th and 150th anniversary of their birth.", 
            'events-up-2-text' : "A concert to pay homage Maurice Ravel after 150 years from his birth", 
            'events-up-3-text' : "Final event of Bottega Sonora's International call for scores, where 9 world premieres will be held in an exlusive concert", 
            'events-up-4-text' : "The final event in the 'Il Suono Sacro' series: a concert that blends spirituality and modernity, featuring music by Brexton and Messiaen, alongside a new work by Jacopo Petrucci commissioned for the occasion.", 
            'events-up-5-text' : "Two anniversaries to celebrate: Luciano Berio and Maurice Ravel. A program that combines iconic masterpieces like Bolero and Folk Songs with surprising gems like Chansons Madécasses and the captivating Stripsody.", 
            'events-up-6-text' : "A concert to celebrate one of the 900s greatest composer, during the 150 anniversary from his birth", 
        ...
        'it': {
            ...
            'team-pp-paolo-1' : "Ha studiato presso il Conservatorio 'G. Braga' di Teramo e presso il Conservatorio 'S. Pietro a Majella' di Napoli, sotto la guida in entrambi i corsi del Maestro Alessandro Santucci. Partecipa alle produzioni di numerose orchestre (Orchestra Papillon, European Play-Day Malta Orchestra, Orchestra dell'Estate Musicale Frentana, Orchestra Sinfonica Abruzzese, Roma Tre Orchestra, Orchestra da Camera 'Benedetto Marcello'). Coltiva da anni la passione per la composizione. I suoi brani 'Ouverture Aprutina' e 'Historia D.A.G.H.E.' sono eseguiti presso la rassegna di musica contemporanea 'MusAnima'. Fin dall'inizio della sua carriera ha dimostrato un vivo interesse per i generi musicali più disparati, che lo ha portato a studiare il basso elettrico e a cimentarsi in vari ambiti attraverso registrazioni inedite (Shijo X, Francesco Sbraccia, Le Ceneri, Keys). Appena laureato ha iniziato a dedicarsi allo studio e alla pratica dell'insegnamento, collaborando come esperto esterno presso diversi istituti sia strumentali che di didattica musicale; nell'A.A. 2022/2023 è docente di Viola e Musica d'insieme presso l'Accademia Musicale di Silvi-Pineto. Attualmente è concertista di viola dell'Istituzione Sinfonica Abruzzese e segue i corsi di perfezionamento presso il Progetto AVOS con Danusha Waskiewicz (Quartetto Prometeo).",
            ...
            'events-up-1-title' : "Omaggio, e grazie infinite, a Berio e Ravel", 
            'events-up-1-text' : "Un concerto per omaggiare Berio e Ravel, in occasione dei 100 e 150 anni dalla loro nascita.", 
            'events-up-2-text' : "Un concerto per omaggiare Maurice Ravel, in occasione dei 150 anni dalla sua nascita", 
            'events-up-3-text' : "Evento conclusivo della call for score internazionale, con l'esecuzione di 9 prime esecuzioni assolute provenienti da tutto il mondo ", 
            'events-up-4-text' : 'Ultimo appuntamento della rassegna “Il Suono Sacro”: un concerto che intreccia spiritualità e contemporaneità, con musiche di Brexton e Messiaen, accanto a una nuova creazione di Jacopo Petrucci commissionata per l’occasione.', 
            'events-up-5-text' : 'Due anniversari da celebrare: Luciano Berio e Maurice Ravel. Un programma che unisce capolavori iconici come il Bolero e le Folk Songs a gemme sorprendenti come le Chansons Madécasses e la travolgente Stripsody.', 
            'events-up-6-text' : 'Un concerto per celebrare uno dei più grandi compositori del 900, nel 150 anniversario dalla sua nascita.', 
            ...
            'pe-subtitle3' : 'ORGANICO',
            'pe-subtitle4' : 'DURATA',
            'pe-subtitle5' : 'SCADENZA',
            'pe-subtitle6' : "L'EVENTO",
            'pe-subtitle7' : "Storico dei Brani",
            'pe-paragraph0' : "Puoi leggere il regolamento completo nel bando ufficiale dell'evento",
            'pe-paragraph2' : "Le partiture dovranno pervenire direttamente tramite lo specifico Form. L'organizzatore dell'evento le inoltrerà all’ensemble designato, rigorosamente in forma anonima",
            'pe-paragraph3' : 'L’organico verrà stabilito con congruo anticipo e varierà per ogni edizione. Ciò costituirà un fattore determinante per i compositori che, per partecipare, dovranno necessariamente presentare un brano composto per l’organico dichiarato nel bando, non pubblicato da un editore e che non abbia già avuto esecuzioni pubbliche.',
            'pe-paragraph4' : 'La durata delle composizioni potrà variare da un minimo di 3 fino a un massimo di 8 minuti.',
            'pe-paragraph5' : 'In previsione dell’appuntamento annuale, l’organico verrà generalmente definito e ufficializzato nell’apposito bando durante la parte iniziale dell’anno e contestualmente verranno anche comunicati il luogo e la data (o indicativamente il periodo) nella quale si svolgerà l’evento. ',
            'pe-paragraph6' : 'I brani pervenuti agli organizzatori verranno eseguiti in pubblico in una o (eventualmente) più giornate, in una sorta di maratona musicale. Sarà inoltre garantita una registrazione integrale dell’esecuzione dei brani, con una microfonia dedicata per ciascuno strumento coinvolto, e il file della registrazione verrà condiviso direttamente con i compositori del brano, che potranno usufruirne nelle forme e nelle modalità che riterranno più appropriate.',
            'pe-paragraph7' : 'Le finalità del progetto sono quelle di incentivare la realizzazione di nuovi brani musicali e, soprattutto, di garantirne l’esecuzione pubblica, costringendo al tempo stesso i compositori a essere estremamente chiari, non potendo comunicare con l’ensemble fino al termine della prima esecuzione.  Inoltre, l’appuntamento a cadenza annuale mira a creare un punto di riferimento per chi vorrà ascoltare ciò che i compositori ci proporranno, di volta in volta, provando a capire come la scrittura musicale si sta evolvendo nel tempo, almeno nella nostra sfera d’influenza, e come personalità differenti interpretano un medesimo compito, una determinata tematica e/o uno specifico organico.',
            'pe-paragraph8' : "Troppo spesso i brani realizzati nelle classi di composizione non vengono eseguiti a causa delle difficoltà nel reperire interpreti disposti a investire il proprio tempo, quando sarebbe invece doveroso premiare i migliori lavori ed eseguirli in queste occasioni. Per questo ed altri motivi, è stata già avviata una collaborazione del Conservatorio A. Casella, in quanto denominatore comune della formazione accademica di tutti i membri del collettivo, che può a tempo stesso giovare dell’opportunità di promuovere i suoi allievi ed ex-allievi, sia a livello di esecutori che di compositori.  Per valorizzare ulteriormente il lavoro dei compositori, sono stati istituiti due premi speciali, attribuiti su insindacabile giudizio dei rappresentanti degli enti promotori:",
