...
function setLanguage(language) {
    ...
    const texts = {
        'en': {
            ...
            'pe-paragraph2' : 'Scores must be submitted directly to the project organizer at the email address <a href="mailto:prime.esecuzioni@bsensemble.com">prime.esecuzioni@bsensemble.com</a>. The organizer will then forward them to the designated ensemble in strictly anonymous form.',
        ...
        'it': {
            ...
            'pe-paragraph2' : 'Le partiture dovranno pervenire direttamente all’organizzatore del progetto all’indirizzo email prime.esecuzioni.bse@gmail.com, il quale le inoltrerà all’ensemble designato, rigorosamente in forma anonima',
